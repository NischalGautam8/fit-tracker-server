...
import { addActivity, getActivities ,getActivityById,deleteActivity, deleteAllActivities, getActivitiesByDays} from '../controllers/activityController';
...
router.get('/past/:days', getActivitiesByDays as RequestHandler);
